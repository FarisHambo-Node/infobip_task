...
class DummyDataGenerator:
    ...
    def generate_channels(self):
        ...
        channels_data = [
            ...
            {'channel_id': 3, 'channel_name': 'Push Notification', 'channel_type': 'Push', 'unit_price_eur': 0.02},
            {'channel_id': 4, 'channel_name': 'Voice Call', 'channel_type': 'Voice', 'unit_price_eur': 0.15},
            {'channel_id': 5, 'channel_name': 'WhatsApp', 'channel_type': 'WhatsApp', 'unit_price_eur': 0.08},
            {'channel_id': 6, 'channel_name': 'Viber', 'channel_type': 'Viber', 'unit_price_eur': 0.06},
            {'channel_id': 7, 'channel_name': 'Telegram', 'channel_type': 'Telegram', 'unit_price_eur': 0.04},
            {'channel_id': 8, 'channel_name': 'Facebook Messenger', 'channel_type': 'Messenger', 'unit_price_eur': 0.07}
        ]
...
def main():
    ...
    customers_df, channels_df, traffic_df = generator.generate_all_data(
        num_customers=100,
        num_days=365,
        upload_to_s3=bool(s3_bucket_name)
    )
